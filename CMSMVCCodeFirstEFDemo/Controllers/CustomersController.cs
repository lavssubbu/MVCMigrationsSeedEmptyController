...
namespace CMSMVCCodeFirstEFDemo.Controllers
{
    public class CustomersController : Controller
    {
        ...
        {
            return View(await _context.customers.Include(o=>o.orders).ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("custId,custName,custLoc,dateofbirth")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("custId,custName,custLoc,dateofbirth")] Customer customer)
        {
